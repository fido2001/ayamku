...
class ProgressDetailController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $progress = Progress::join('kandang', 'kandang.id', '=', 'data_progress.id_kandang')->join('users', 'kandang.user_id', '=', 'users.id')->where('users.id', '=', $user_id)->select('data_progress.*')->get();
